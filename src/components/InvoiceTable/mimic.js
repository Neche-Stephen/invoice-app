...
import { getFirestore, doc, getDoc, setDoc, collection, addDoc, getDocs, query, where, orderBy,
  limit, startAfter
...
export default function InvoiceTable() {
  ...
  const totalPages = Math.ceil(currentInvoices.length / invoicesPerPage);
   ...
   // const paginate = (pageNumber) => setCurrentPage(pageNumber); recent
    ...
    <div>
      ...
      <Container fluid>
        <Row className='justify-content-between'>
            <Col lg = '3' className='dashboard-navbar navbar-brand p-3 text-center' ><h5 className='dashboard-navbar-brand'>Invoices</h5></Col>
